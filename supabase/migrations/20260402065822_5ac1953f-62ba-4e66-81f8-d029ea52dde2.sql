...
-- Projects RLS: anyone can view
CREATE POLICY "Anyone can view projects" ON public.projects FOR SELECT USING (true);
-- Projects RLS: only admin can insert
...
-- Projects RLS: only admin can update
...
-- Projects RLS: only admin can delete
...
-- Bookings RLS: only admin can update
...
-- Bookings RLS: only admin can delete
